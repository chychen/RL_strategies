...
class PPO(object):
    ...
    def _initialize_policy(self):
        ...
        def is_tensor(x): return isinstance(x, tf.Tensor)
        policy_params = tools.nested.filter(
            is_tensor, output.policy.parameters)

        def set_batch_dim(x): return utility.set_dimension(
