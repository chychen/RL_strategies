...
class BBallWrapper(object):
    ...
    def __init__(self, env, data, if_clip=True, if_norm_obs=True, if_norm_act=True, init_mode=1, if_vis_trajectory=False, if_vis_visual_aid=False, init_positions=None, fps=5, time_limit=240):
        """
        Args
        ----
